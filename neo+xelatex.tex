...
\section{Gegenwart}
Seit dieser Zeit wird \neoii entwickelt, dessen Referenz Ende März eingefroren wurde und das somit stabil ist. \cite{neo2} Gegenüber der ersten Version wurden viele grundlegende Änderungen vorgenommen, wobei die Belegung der Buchstaben zu großen Teilen gleich blieb. Die Abbildung zeigt die aktuelle Belegung. Diese weist nach langen Tests im alltäglichen Umgang vieler Entwickler sowie durch umfangreiche Diskussionen eine optimierte Verteilung der Buchstaben auf.
\newpage
\begin{center}
\includegraphics[width=.7\textwidth]{ebene12}
\captionof{figure}{\neoii – erste und zweite Ebene, Buchstaben und Spezialzeichen. (Großbuchstaben zur Übersicht nicht dargestellt.) \newline \textsf{M1}\,–\,\textsf{M3} stehen für die „Modifier“, vergleichbar \textsf{Shift} (\textsf{M2}) und \textsf{Alt Gr} (\textsf{M3}). \textsf{T1}\,–\,\textsf{T3} sind tote Tasten, die eine Vielzahl an Diakritika bieten – zur Übersicht sind nicht die einzelnen Zeichen dargestellt.}
\end{center}
...
\includegraphics[width=.52\textwidth]{ebene3}\kern-.2em%
\includegraphics[width=.52\textwidth]{ebene4}
\captionof{figure}{Ebene 3: Programmierzeichen, Ebene 4: Navigation, Zahlen}
\end{center}
...
\fixme{Grafik vom nummernblock (.501 textwidth)}
...
\verb1                         \sin\theta e^{i\phi}\right\|^2 \geq 0\]1
\verb| b)| \raisebox{-.8ex}{\includegraphics{neo2.pdf}}
...
Zur Zeit muss man noch manuell definieren, dass \raisebox{-.8ex}{\includegraphics{neo3}} wie |\int, \geq| behandelt werden, aber das (noch) experimentelle Paket \Package{unicode-math} von Will Robertson wird hier Abhilfe schaffen und den direkten Umgang mit unicode-kodierten otf-Matheschriften ermöglichen.
