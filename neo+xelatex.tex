...
\begin{center}
\includegraphics[width=.7\textwidth]{ebene1}
\captionof{figure}{\neoii – erste Ebene, Kleinbuchstaben.\newline \textsf{M1}\,–\,\textsf{M3} stehen für die „Modifier“, vergleichbar \textsf{Shift} (\textsf{M2}) und \textsf{Alt Gr} (\textsf{M3}). \textsf{T1}\,–\,\textsf{T3} sind tote Tasten, die eine Vielzahl an Diakritika bieten.}
\end{center}
